...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print "\nUsage : ./instapass.py <username> <wordlist> <proxylist> <thread>"
        print "Eg: ./instapass.py netcat words.txt proxy.txt 4\n"
        sys.exit(1)
    ...
    print "\n***************************************"
    print "* WelCome To Insta Password Cracking  *"
    print "* Developed By SALEH FEYZI            *"
    print "* saleh[dot]faezy77[at]gmail[dot]com  *"
    print "***************************************"
